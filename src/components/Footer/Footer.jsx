        ...
        <footer className="bg-gray-900 text-gray-300">
            <div className="container mx-auto" style={{ paddingLeft: '1rem', paddingRight: '1rem', paddingTop: '3rem', paddingBottom: '3rem' }}>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    {/* Newsletter */}
                    <div>
                        <h3 className="text-white text-lg font-bold" style={{ marginBottom: '1rem' }}>Newsletter</h3>
                        <p className="text-sm" style={{ marginBottom: '1rem' }}>
                        ...
                        <form className="flex flex-col space-y-2">
                            <input
                                ...
                                className="rounded-lg bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-blue-500 transition"
                ...
                {/* Copyright */}
                <div className="border-t border-gray-800 text-center" style={{ marginTop: '2rem', paddingTop: '2rem' }}>
                    <p className="text-sm">
